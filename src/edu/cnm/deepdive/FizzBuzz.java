 ...
 * or {@link String} results indicating whether the specified values are divisible by 3 (fizz)
 * or 5 (buzz). </p>
 *
...
public class FizzBuzz {
  ...
  /**
   * Computes and returns <code>boolean</code> result to test if
   * <code>value</code> is divisible by 3.
   *
  ...
  /**
   * Computes and returns <code>boolean</code> result to test if
   * <code>value</code> is divisible by 5.
   *
   * @param value Integer value to be tested.
   * @return boolean result.
   */
